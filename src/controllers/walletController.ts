...
export const fetchWallet = expressAsyncHandler(
...
export const updateWallet = expressAsyncHandler(
  async (req: Request, res: Response) => {
    // @ts-ignore
    const user = req.user;
...
export const updateIncome = expressAsyncHandler(
  async (req: Request, res: Response) => {
    // @ts-ignore
    const user = req.user;
...
export const updateBalance = expressAsyncHandler(
  async (req: Request, res: Response) => {
    ...
    const updatedWallet = await Wallet.findOneAndUpdate(
      { id: user.id },
      { $set: { balance: balance, initialBalance: balance } },
      { new: true }
    );
...
export const updateIncomeChanges = expressAsyncHandler(
  async (req: Request, res: Response) => {
    // @ts-ignore
    const user = req.user;
    ...
    const findUser = await Wallet.findOneAndUpdate(
      { email: user.email },
      {
